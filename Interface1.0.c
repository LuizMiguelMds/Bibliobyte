...
void box(int lin1, int col1, int lin2, int col2) {
    const char HORIZONTAL = '-'; // Linha horizontal
    const char VERTICAL = '|';   // Linha vertical
    const char TOP_LEFT = '+';   // Canto superior esquerdo
    const char TOP_RIGHT = '+';  // Canto superior direito
    const char BOTTOM_LEFT = '+';// Canto inferior esquerdo
    const char BOTTOM_RIGHT = '+';// Canto inferior direito
...
int main() {
    int opc;
    char lista[3][40] = {"Novo Livro", "Consultar Livro", "Excluir"};
